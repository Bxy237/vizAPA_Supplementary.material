...
The BAM files for the following analysis can be downloaded here:[mouse.sperm.bam](https://github.com/Bxy237/vizAPA_supplementary.material/tree/master)
...
We can also plot the pA expression in individual cells.
