...
```{r vizStats_dot_PAs, fig.show="hold"}
...
```{r vizStats_violin_allPAs, fig.show="hold"}
...
```{r vizStats_statTheme, fig.show="hold"}
...
```{r vizStats_selGroups, fig.show="hold"}
