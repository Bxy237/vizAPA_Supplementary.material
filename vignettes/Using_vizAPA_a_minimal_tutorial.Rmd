...
The BAM files and the corresponding index (.bai) files for the following analysis can be downloaded from the GitHub site of vizAPA: [mouse.sperm.bam](https://github.com/Bxy237/vizAPA_supplementary.material/tree/master). For demonstration, these BAM files contain only five genes [66514(Asrgl1), 21463 (Tcp11),252868(Odf4)] extracted from the original BAM (accession number: GSM280334).
